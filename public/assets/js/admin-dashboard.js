$(document).ready(function () {
    ...
    //Datatable - Pending Requests By Post (Home button)
    $('#pending_request_table').dataTable(DATA_TABLE_OPTIONS);
    //Datatable - Posted Requests By Post (Home button)
    $('#posted_request_table').dataTable(DATA_TABLE_OPTIONS);
});
