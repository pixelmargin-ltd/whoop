                                                ...
                                                {!! Form::open(['name' => 'frmEditQuoteMessage', 'id' => 'frmEditQuoteMessage', 'files' => true, 'class' => 'form-horizontal', 'method' => 'post', 'enctype' => 'multipart/form-data', 'route' => array('quote-messages.update', $quoteMessage['id'])]) !!}
                                                    <div class="form-group">
                                                        <label class="col-sm-2 control-label no-padding-right"
                                                               for="title">User name</label>
                                                        <div class="col-sm-10">
                                                            <div class="user-data" style="display: block; height: 30px;">
                                                                <div class="radio"><label><input type="radio" name="user_id" id="{{$user[0]['id']}}" value="{{$user[0]['id']}}" checked="checked" /><span class="text">{{$user[0]['firstname']}}</span></label></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <?php 
