...
Route::group(array('prefix' => 'admin', 'middleware' => ['auth', 'admin']), function () {
    ...
    Route::group(['middleware' => 'auth'], function () {
        ...
        Route::post('/quote-messages/add/getUsers', array('as' => 'quote-messages.getUsers', 'uses' => 'Admin\Message\QuoteMessageController@getUsers'));
        Route::post('/quote-messages/edit/getDeals', array('as' => 'provider.getDeals', 'uses' => 'Admin\ServiceProviderController@getDeals'));
        /*------------------ Quote Message -----------------*/

        /*------------------ Home Button -----------------*/
        Route::get('/home_button/request/list', [
            'as' => 'home-button.request.list',
            'uses' => 'Admin\HomeButtonController@listHomeButtons'
        ]);
        Route::get('/home_button/request/{request_id}/posted', [
            'as' => 'home-button.request.posted',
            'uses' => 'Admin\HomeButtonController@codePosted'
        ]);
        Route::get('/home_button/request/{request_id}/revert', [
            'as' => 'home-button.request.revert',
            'uses' => 'Admin\HomeButtonController@revertStatus'
        ]);
        Route::delete('/home_button/request/{request_id}/destroy', [
            'as' => 'home-button.request.destroy',
            'uses' => 'Admin\HomeButtonController@destroy'
        ]);
        /*------------------ Home Button -----------------*/
    });
});
