<div class="page-sidebar" id="sidebar">
    ...
    <ul class="nav sidebar-menu">
        ...
        <li>
            <a href="<?php echo e(route('home-button.request.list')); ?>">
                <i class="menu-icon glyphicon glyphicon-home"></i>
                <span class="menu-text"> Home Buttons </span>
            </a>
        </li>
        <li>
    ...
    <!-- <li>
        ...
        <li>
            <a href="<?php echo e(route('boost_code_providers.index')); ?>">
        ...
        <li>
            <a href="<?php echo e(route('global_messages.index')); ?>">
                <i class="menu-icon glyphicon glyphicon-inbox"></i>
        ...
        <li>
            <a href="<?php echo e(url('admin/quote-messages/list')); ?>">
                <i class="menu-icon glyphicon glyphicon-inbox"></i>
