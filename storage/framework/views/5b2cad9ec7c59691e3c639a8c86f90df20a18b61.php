                                    ...
                                    <div class="col-lg-12 col-sm-12 col-xs-12">
                                        <div class="widget">
                                            <div class="">
                                                ...
                                                <?php echo Form::open(['name' => 'frmAddMessage', 'id' => 'frmAddCategory', 'files' => true, 'class' => 'form-horizontal', 'method' => 'post', 'enctype' => 'multipart/form-data', 'route' => 'messages.create']); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <textarea name="message" id="message"
                                                                  class="form-control" rows="5"><?php echo e(isset($message)?$message['message']:''); ?></textarea>
                                                    </div>
                                                </div>
