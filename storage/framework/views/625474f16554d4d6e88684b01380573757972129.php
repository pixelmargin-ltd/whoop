...
<html lang="en">
   <head>
      ...
      <link rel="stylesheet" href="<?php echo URL::asset('front_assets/css/bootstrap.min.css'); ?>">
      <link rel="stylesheet" href="<?php echo URL::asset('front_assets/css/font-awesome.min.css'); ?>">
      <link rel="stylesheet" href="<?php echo URL::asset('front_assets/css/responsive.css'); ?>">
      <link rel="stylesheet" href="<?php echo URL::asset('front_assets/css/style.css'); ?>">
      ...
      <script type="text/javascript">
          API_BASE_URL = "<?php echo URL::to('/'); ?>/api/";
   ...
   <body>
      ...
      <script src="<?php echo URL::asset('front_assets/js/owl.carousel.js'); ?>"></script>
      ...
      <script src="<?php echo URL::asset('front_assets/js/jquery.marquee.min.js'); ?>"></script>
      <script src="<?php echo URL::asset('front_assets/js/jquery.validate.js'); ?>"></script>
      <script src="<?php echo URL::asset('front_assets/js/custom_validation.js'); ?>"></script>
        <script type="text/javascript">
