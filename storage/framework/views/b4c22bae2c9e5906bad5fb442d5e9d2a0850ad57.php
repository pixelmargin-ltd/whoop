...
<html lang="en">
    <head>
        ...
        <link href="<?php echo URL::asset('front_assets/css/bootstrap.css'); ?>" rel="stylesheet">
        <link rel="stylesheet" href="<?php echo URL::asset('front_assets/css/responsive.css'); ?>">
        <link rel="stylesheet" href="<?php echo URL::asset('front_assets/owlcarousel/assets/owl.carousel.css'); ?>">
        <link rel="stylesheet" href="<?php echo URL::asset('front_assets/owlcarousel/assets/owl.theme.default.min.css'); ?>">
        <link href="<?php echo URL::asset('front_assets/css/style.css'); ?>" rel="stylesheet">
        <link href="<?php echo URL::asset('front_assets/css/web-style.css'); ?>" rel="stylesheet">
        <link rel="stylesheet" href="<?php echo URL::asset('front_assets/css/style_custom.css'); ?>">
    </head>
    <!-- NAVBAR
        ================================================== -->
    <body>
                                ...
                                <div class="row">
                                    <div class="large-12 columns m_t_30">
                                        <div class="getting_ready_icon ">
                                            <img src="<?php echo URL::asset('front_assets/images/personal-whoops.png'); ?>">
                                ...
                                <div class="row">
                                    <div class="large-12 columns">
                                        <div class="message-wapper text_orange no_underline">
                                            ...
                                            <p class="m0 p10">You can use your personal button straight away or you can swipe to see your home's button and verify your address <a href="logout">logout</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row" id="cuts">
                                    ...
                                    <div class="col-md-6">
                                        <div class="unlock-icon-bg">
                                            <div class="unlock-icon">
                                                <a href="unlock-to-join.html"><img src="<?php echo URL::asset('front_assets/images/unlock-icon_gray.png'); ?>" alt="" title=""></a>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="unlock-icon-bg">
                                            ...
                                            <a href="invite.html">
                                                <div class="unlock-icon">
                                                    <img src="<?php echo URL::asset('front_assets/images/invite-g.png'); ?>" alt="" title="" style="min-width: 43px;">
                                                </div>
                        ...
                        <section id="demos2" class="bg_color bg_pwhoops">
                            <div class="container">
                                <div class="row">
                                    <div class="large-12 columns m_t_30">
                                        <div class="getting_ready_icon ">
                                            <img src="<?php echo URL::asset('front_assets/images/home-whoops-btn.png'); ?>">
                                            <ul class="circle_wave home_circle_wave clearfix">
                                                <li>
                                                    <a href="web-deal-detail.html">
                                                    <span> Deal Left </span>
                                ...
                                <div class="row">
                                    <div class="large-12 columns">
                                        <div class="message-wapper">
                                            <a href="#popup5">
                                                <!-- <span class="icon"><img src="images/error-1-icon.png"></span> --><span class="text">Verify address to unlock your button <u> 16, Westway, London, SW1 1AW</u>
                                            </a>
                                            </span>
                                        </div>
                                    </div>
                            ...
                            <div class="container">
                                ...
                                <div class="row" id="cuts">
                                    <div class="col-md-6">
                                        <div class="unlock-icon-bg">
                                            <div class="unlock-icon">
                                                <a href="javascript:void(0)"><img src="<?php echo URL::asset('front_assets/images/unlock_orange.png'); ?>" alt="" title=""></a>
                                            </div>
                                            <div class="unlock-title">Verify
                                                <br>
                                                <span>Verify Address to Unlock Your Button</span>
	                ...
	                <div class="item first">
	                    <div class="main_caption first">
	                        <div class="caption">
	                            ...
	                            <div class="img_bg">
	                                <img src="<?php echo URL::asset('front_assets/images/box_icon.png'); ?>">
	                            </div>
	                            <div class="btn_popup" style="position: unset;">
	                ...
	                <div class="item">
	                    <div class="main_caption second">
	                        <div class="caption">
	                            ...
	                            <div class="img_bg">
	                                <img src="<?php echo URL::asset('front_assets/images/green-monry.png'); ?>">
	                            </div>
	                            <div class="btn_popup" style="position: unset;">
  	...
  	<script src="<?php echo URL::asset('front_assets/js/jquery.min.js'); ?>"></script>
    <script src="<?php echo URL::asset('front_assets/js/popper.min.js'); ?>"></script>
    <script src="<?php echo URL::asset('front_assets/owlcarousel/owl.carousel.js'); ?>"></script>
    <script src="<?php echo URL::asset('front_assets/js/bootstrap.min.js'); ?>"></script>
    <script src="<?php echo URL::asset('front_assets/js/script.js'); ?>"></script>
        <style type="text/css">
