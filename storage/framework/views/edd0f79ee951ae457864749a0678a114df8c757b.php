<?php $__env->startSection('title', 'Add New Boost Code ServiceProvider'); ?>
                                            ...
                                            <div class="">
                                                ...
                                                <?php endif; ?>
                                                    ...
                                                    if (isset($boostCodeProvider)) {
                                                        $action = route('boost_code_providers.update',
                                                            $boostCodeProvider['id']);
                                                    } else {
                                                        $action = route('boost_code_providers.store');
                                                    }
                                                    ?>
                                                <form action="<?php echo e($action); ?>"
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-sm-offset-2 col-sm-10">
                                                            <button type="submit"
                                                                    name="submitBoostCodeProvider"
                                                                    id="submitBoostCodeProvider"
                                                                    class="btn btn-primary">
                                                                <?php echo e(isset($boostCodeProvider)?'Update':'Add'); ?>
